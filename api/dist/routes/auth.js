...
router.post('/request', async (req, res) => {
    ...
    try {
        ...
        await db_1.pool.query("INSERT INTO audit_log (actor_id,action,entity_type,entity_id,bank_id,metadata) VALUES ($1,'auth.requested','user',$1,$2,$3)", [userId, bankId, JSON.stringify({ ip: req.ip })]);
...
router.get('/verify', async (req, res) => {
    ...
    try {
        ...
        await db_1.pool.query("INSERT INTO audit_log (actor_id,action,entity_type,entity_id,bank_id,metadata) VALUES ($1,'auth.login','user',$1,$2,$3)", [t.user_id, t.bank_id || null, JSON.stringify({ ip: req.ip })]);
