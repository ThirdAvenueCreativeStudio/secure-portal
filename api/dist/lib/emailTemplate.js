...
exports.APP = exports.RED = exports.GREEN = exports.GOLD = exports.NAVY = void 0;
...
exports.APP = APP;
function emailLayout(content, footer = true) {
...
function emailButton(url, label, color = NAVY) {
...
function emailHeading(text, color = NAVY) {
...
function emailBadge(label, bg, color) {
